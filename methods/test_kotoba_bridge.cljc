...
(deftest internal-trust-header-present-when-configured
  (let [seen (atom nil)
    ...
    (with-redefs [kb/internal-trust (constantly synthetic-trust)]
      (kb/default-transport "http://127.0.0.1:8077/xrpc/x" {} {:http-post capture :operator-did "did:key:zSyntheticTestOperator"})
...
(deftest internal-trust-header-absent-when-unconfigured
  (let [seen (atom nil)
        capture (fn [_u _b headers _t] (reset! seen headers) {:status "ok"})]
    (with-redefs [kb/internal-trust (constantly nil)]
      (kb/default-transport "http://127.0.0.1:8077/xrpc/x" {} {:http-post capture :operator-did "did:key:zSyntheticTestOperator"})
...
(deftest internal-trust-absence-is-reported-not-silent
  (with-redefs [kb/internal-trust (constantly nil)]
    (is (= :unconfigured (kb/internal-trust-status))))
  (with-redefs [kb/internal-trust (constantly synthetic-trust)]
    (is (= :configured (kb/internal-trust-status)))))
...
(deftest allowlist-still-enforced-alongside-internal-trust
  (with-redefs [kb/internal-trust (constantly synthetic-trust)]
    (is (thrown? clojure.lang.ExceptionInfo
                 (kb/default-transport "http://evil.example.com/x" {}
